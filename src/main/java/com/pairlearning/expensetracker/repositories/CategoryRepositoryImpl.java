...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    private static final String SQL_FIND_BY_ID = "SELECT C.CATEGORY_ID, C.USER_ID, C.TITLE, C.DESCRIPTION, COALESCE" +
            "(SUM(T.AMOUNT), 0) TOTAL_EXPENSE FROM ET_TRANSACTIONS T RIGHT OUTER JOIN ET_CATEGORIES C ON C" +
    ...
    @Override
    public Integer create(Integer userId, String title, String description) throws EtBadRequestionException {
        try {
            ...
            throw new EtBadRequestionException("Invalid request");
        }
    }

    @Override
    public void update(Integer userId, Integer categoryId, Category category) throws EtBadRequestionException {
